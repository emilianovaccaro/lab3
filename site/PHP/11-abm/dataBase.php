<?php 
    ...
    { 
        ...
        $sql = "SELECT * FROM automoviles WHERE ID LIKE CONCAT('%',:FId,'%') AND Marca LIKE CONCAT('%',:FMarca ,'%') AND Modelo LIKE CONCAT('%',:FModelo ,'%') AND Precio LIKE CONCAT('%',:FPrecio ,'%') AND Anio LIKE CONCAT('%',:FAnio ,'%') ORDER BY $orden";
